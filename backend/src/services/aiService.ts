import { AnswerEvaluation, InterviewQuestion, RoleType } from "../types/index.js";
...
Evaluate the answer and return ONLY valid JSON in this exact structure:
{
  ...
  private heuristicEvaluate(
    ...
    return {
      ...
      feedback: `Your response demonstrates a clear understanding of the core concept. To make it stand out to hiring managers for ${role}, strengthen the explanation with concrete system trade-offs and quantifiable impact.`,
