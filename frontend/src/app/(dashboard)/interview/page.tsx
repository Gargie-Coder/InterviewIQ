          ...
          <Card>
            ...
            <CardContent className="space-y-3 pt-1 text-xs">
              <div className="flex justify-between border-b border-slate-100 pb-2">
                ...
                <span className="font-semibold text-slate-900">{user?.name || "Candidate"}</span>
              </div>
              <div className="flex justify-between border-b border-slate-100 pb-2">
              ...
              <div className="flex justify-between border-b border-slate-100 pb-2">
                ...
                <span className="font-semibold text-slate-900">{user?.experienceYears || 1} Years</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Track Type:</span>
                <span className="font-semibold text-slate-900">{user?.preferredInterviewType || "Mixed"}</span>
              </div>
            </CardContent>
          </Card>
